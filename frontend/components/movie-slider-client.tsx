...
export default function MovieSliderClient({ movies }: { movies: MovieSummaryDto[] }) {
  if (!movies.length) {
    return (
      <div className="bg-black text-white py-8">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-white/70 py-12">Chưa có phim nổi bật.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="bg-black text-white py-8">
      <div className="container mx-auto px-4">
        ...
        <Carousel className="w-full">
          <CarouselContent>
            {movies.map((movie) => {
              const primaryGenre = movie.genres[0]?.name ?? "Phim"
              return (
